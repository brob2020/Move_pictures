...
### checking if we need to encode  the images of if we have them already.
...
def image_encode(im_Code=u_encoded,image=new_Image ,pathLoc = "./images" , name_Codefile = "Unknow_faces.json",data_file=new_Faces_F):
...
print(classify_fae("./faces/Kratos.jpg", know_faces_F))
